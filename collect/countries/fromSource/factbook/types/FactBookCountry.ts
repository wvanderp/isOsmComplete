...
export interface Economy {
    'Economic overview'?: InternetCountryCode;
    ...
    Exports?: Exports;
    'Exports - partners'?: InternetCountryCode;
    'Exports - commodities'?: InternetCountryCode;
    Imports?: Imports;
    'Imports - partners'?: BroadcastMedia;
    'Imports - commodities'?: InternetCountryCode;
...
export interface CurrentAccountBalance {
    ...
    'Current account balance 2022'?: BroadcastMedia;
    note?: string;
}
...
export interface RealGDPPurchasingPowerParity {
    ...
    text?: string;
    'Real GDP (purchasing power parity) 2022'?: BroadcastMedia;
...
export interface RealGDPGrowthRate {
    ...
    'Real GDP growth rate 2022'?: BroadcastMedia;
...
export interface RealGDPPerCapita {
    ...
    'Real GDP per capita 2022'?: BroadcastMedia;
...
export interface NuclearEnergy {
    'Number of operational nuclear reactors': BroadcastMedia;
    'Number of nuclear reactors under construction': BroadcastMedia;
    'Net capacity of operational nuclear reactors': BroadcastMedia;
    'Percent of total electricity production': BroadcastMedia;
    'Percent of total energy produced': BroadcastMedia;
    'Number of nuclear reactors permanently shut down'?: BroadcastMedia;
    note?: string;
}
...
export interface Space {
    'Space agency/agencies': InternetCountryCode;
    'Space program overview': InternetCountryCode;
    'Space launch site(s)'?: BroadcastMedia;
}
